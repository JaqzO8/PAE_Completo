...
export const StudentLayout = ({ children }: Props) => {
  ...
  // 1️COMUNIDADES (más específico primero)
  if (pathname.startsWith("/estudiante/grupos")) {
  ...
  // 2️REPOSITORIOS
    ...
    pathname.startsWith("/estudiante/repositorios") ||
    pathname === "/estudiante/explorar" ||
    pathname.startsWith("/estudiante/biblioteca")
  ) {
